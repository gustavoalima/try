...
const AvaliacaoFeminina = () => {
  ...
  const salvarAvaliacao = async () => {
    ...
    try {
      const response = await axios.post("http://localhost:3000/avaliacao-feminina", {
        aluno_id: alunoId,
        nome,
        idade,
        peso,
  ...
  return (
    <div style={styles.container}>
      <h2 style={styles.title}>Avaliação Feminina</h2>
      ...
      {resultados && (
        <div style={styles.results}>
          ...
          <p>
            <strong>Percentual de Gordura:</strong> {resultados.percentualGordura}%
          </p>
          <p>
            <strong>Percentual de Massa Magra:</strong>{" "}
            {resultados.percentualMassaMagra}%
          </p>
          <p>
            <strong>Densidade Corporal:</strong> {resultados.densidadeCorporal}
          </p>
          <p>
            <strong>Massa Gordura:</strong> {resultados.massaGorduraKg} kg
          </p>
          <p>
            <strong>Massa Magra:</strong> {resultados.massaMagraKg} kg
          </p>
          <p>
            <strong>IMC:</strong> {resultados.imc}
          </p>
          <p>
            <strong>Classificação IMC:</strong> {resultados.classificacaoIMC}
          </p>
        </div>
      )}
    </div>
